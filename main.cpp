...
int main(int argc, char *argv[])
{
    ...
    personne Mohamed{"KHELIL", "mohamed", "0603030123", "mohamed.khelil@uha.fr"};
    ldc.ajouterPersonne(Mohand);
    ldc.ajouterPersonne(Youcef);
    ldc.ajouterPersonne(Maria);
    ldc.ajouterPersonne(Mohamed);
    ...
    rdv_ldc.ajouterARdv(ldc.trouverPersonne("SARNI", "youcef"), "Séminaire");
    rdv_ldc.ajouterARdv(ldc.trouverPersonne("KHELIL", "mohamed"), "Séminaire");
